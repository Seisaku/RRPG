...
local function constructNew_frmAtalhosAcoes()
    ...
    obj.label1:setMargins({left = 1, top = 5});
    obj.label1:setText("Desejo");
    obj.label1:setName("label1");

    obj.edit1 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit1:setParent(obj.flowLayout1);
    obj.edit1:setField("atalhos.desejoUso");
    obj.edit1:setHeight(20);
    obj.edit1:setHorzTextAlign("center");
    obj.edit1:setMargins({left = 1, top = 5});
    obj.edit1:setMin(0);
    ...
    obj.label2:setMargins({left = 1, top = 5});
    obj.label2:setText("Falhas Oponente");
    obj.label2:setName("label2");

    obj.edit2 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit2:setParent(obj.flowLayout1);
    obj.edit2:setField("atalhos.falhasOponente");
    obj.edit2:setHeight(20);
    obj.edit2:setHorzTextAlign("center");
    obj.edit2:setMargins({left = 1, top = 5});
    obj.edit2:setMin(0);
